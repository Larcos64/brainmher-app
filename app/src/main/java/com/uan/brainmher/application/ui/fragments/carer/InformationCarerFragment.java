...
public class InformationCarerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        loadAlzheimerInformation("general"); // Puedes ajustar el tipo según el filtro deseado
        return binding.getRoot();
    }

    private void loadAlzheimerInformation(String type) {
        repository.getInformationCarer(type, new InformationCarerRepository.OnInformationCarerLoaded() {
            @Override
            public void onSuccess(List<InformationCarer> informationList) {
    ...
    private void displayInformationPanels(List<InformationCarer> informationList) {
        for (InformationCarer info : informationList) {
